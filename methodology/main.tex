...
{\sum_i E^{mkt}_{i,t}}.
\end{equation}
This aggregation gives larger institutions proportionally larger weight through their balance sheets and market capitalization.
...
The script uses public market prices, shares outstanding, and financial statement fields available through Yahoo Finance. Coverage depends on the availability and consistency of these fields across jurisdictions and listing venues. For London-listed shares, prices are converted from pence to pounds before computing market capitalization.
